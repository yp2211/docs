...
![](./img/jvm.classloader.1_zh_cn.png)
...
![](./img/jvm.classloader.2_zh_cn.png)
...
![](./img/jvm.classloader.3_zh_cn.png)
...
public class MyClassLoaderTest {
    ...
    public static void main(String args[]) throws Exception {
        ...
        //D盘创建 test/com/rocdocs/jvm 几级目录，将User类的复制类User1.class丢入该目录
...
**Tomcat自定义加载器详解**
![](./img/jvm.classloader.4_zh_cn.png)
